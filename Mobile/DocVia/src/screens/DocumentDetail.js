...
function warningTone(item) {
  ...
  if (['informativo', 'info', 'baixa', 'low'].includes(priority)) return { key: 'Info', label: 'INFORMATIVO', color: '#76D9DC' };
...
export default function DocumentDetail({ id, back }) {
  ...
  return <ScrollView style={common.screen} contentContainerStyle={styles.content}>
    <Pressable accessibilityRole="button" accessibilityLabel="Voltar" onPress={back} style={styles.back}><ArrowLeft size={17} color="#76D9DC" /><Text style={styles.backText}>Voltar</Text></Pressable>
...
const styles = StyleSheet.create({
  ...
  back: { flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', gap: 5, paddingVertical: 8, marginBottom: 23 }, backText: { color: '#B7AEFF', fontSize: 12, fontWeight: '800' },
  heading: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, headingCopy: { flex: 1 }, title: { color: '#F0FAFB', fontSize: 24, lineHeight: 29, fontWeight: '800' }, meta: { color: '#888A99', fontSize: 11, marginTop: 8 }, status: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 14, backgroundColor: '#168B941F' }, statusError: { backgroundColor: '#EF44441F' }, statusText: { color: '#ACA3FF', fontSize: 9, fontWeight: '900', letterSpacing: 1 }, statusTextError: { color: '#FF8992' },
  ...
  tabs: { flexDirection: 'row', gap: 4, paddingTop: 24, paddingBottom: 21 }, tab: { flex: 1, height: 40, paddingHorizontal: 4, borderRadius: 14, borderWidth: 1, borderColor: '#24434A', backgroundColor: '#0B171A', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 3, minWidth: 0 }, tabActive: { backgroundColor: violet, borderColor: violet }, tabText: { color: '#9AB4B8', fontSize: 9, fontWeight: '700', flexShrink: 1 }, tabTextActive: { color: '#FFFFFF' }, pressed: { opacity: .82, transform: [{ scale: .99 }] },
  result: { minHeight: 198 }, summary: { color: '#DEDEE6', fontSize: 13, lineHeight: 22 }, sectionTitle: { color: '#F0FAFB', fontSize: 16, fontWeight: '800', marginTop: 23, marginBottom: 11 }, emptyText: { color: '#9597A5', fontSize: 12 }, card: { borderRadius: 18, borderWidth: 1, borderColor: '#24434A', backgroundColor: '#0B171A', padding: 16 }, actionCard: { marginTop: 8 }, actionText: { color: '#DCDDE6', fontSize: 12, lineHeight: 18, flex: 1 }, dataCard: { marginBottom: 9, flexDirection: 'row', alignItems: 'center' }, dataCopy: { flex: 1 }, dataTitle: { color: '#ECECF3', fontSize: 13, fontWeight: '700' }, dataHint: { color: '#8B8D9A', fontSize: 11, marginTop: 5 }, smallButton: { backgroundColor: '#168B941F', borderRadius: 11, paddingHorizontal: 10, paddingVertical: 7 }, smallButtonText: { color: '#B9B0FF', fontSize: 10, fontWeight: '800' }, warningCard: { marginBottom: 9, flexDirection: 'row', alignItems: 'center', gap: 10 }, warningIcon: { width: 30, height: 30, borderRadius: 10, backgroundColor: '#FFFFFF08', alignItems: 'center', justifyContent: 'center' }, warningCopy: { flex: 1 }, warningLabel: { fontSize: 9, letterSpacing: 1.1, fontWeight: '900', marginBottom: 5 }, warningAttention: { borderColor: '#5B4822', backgroundColor: '#1B1710' }, warningCritical: { borderColor: '#6B3039', backgroundColor: '#211216' }, warningInfo: { borderColor: '#343071', backgroundColor: '#121125' }, copyButton: { flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', gap: 7, marginTop: 15, paddingVertical: 6 }, copyText: { color: '#B7AEFF', fontSize: 11, fontWeight: '800' },
  disclaimer: { color: '#8F919E', fontSize: 10, lineHeight: 16, marginTop: 20 }, originalCard: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 14 }, originalIcon: { width: 40, height: 40, borderRadius: 14, backgroundColor: '#191532', alignItems: 'center', justifyContent: 'center' }, originalCopy: { flex: 1 }, originalTitle: { color: '#F0FAFB', fontSize: 14, fontWeight: '800' }, originalText: { color: '#9597A5', fontSize: 11, lineHeight: 16, marginTop: 5 }

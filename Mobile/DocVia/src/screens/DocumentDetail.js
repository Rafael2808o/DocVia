...
function warningTone(item) {
  ...
  if (['informativo', 'info', 'baixa', 'low'].includes(priority)) return { key: 'Info', label: 'INFORMATIVO', color: '#A99DFF' };

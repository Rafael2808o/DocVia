...
function Field({ label, icon, children }) {
  ...
  const focusStyle = useAnimatedStyle(() => ({ borderColor: interpolateColor(focused.value, [0, 1], ['#24434A', accent]), shadowColor: accent, shadowOpacity: focused.value * .28, shadowRadius: focused.value * 10, elevation: focused.value * 4 }));
...
const styles = StyleSheet.create({
  legacy: { justifyContent: 'center', flexGrow: 1, gap: spacing.md }, keyboard: { flex: 1 }, screen: { flexGrow: 1, paddingHorizontal: 39, backgroundColor: '#071012' }, brand: { color: '#39C6CB', fontSize: 11, fontWeight: '900', letterSpacing: 3, marginBottom: 20 }, title: { color: '#F7F5FA', fontSize: 29, lineHeight: 36, letterSpacing: .3, fontWeight: '800' }, subtitle: { color: '#B8B4C5', fontSize: 13, marginTop: 11 }, fieldLabel: { color: '#79758E', fontSize: 9, fontWeight: '800', letterSpacing: 1.6, marginTop: 5 }, authField: { height: 53, borderRadius: 20, borderWidth: 1, borderColor: '#24434A', backgroundColor: '#171720', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 17, gap: 13 }, authFieldFocused: { borderColor: accent, shadowColor: accent, shadowOpacity: .28, shadowRadius: 10, shadowOffset: { width: 0, height: 0 }, elevation: 4 }, authInput: { flex: 1, color: '#F7F5FA', fontSize: 13, paddingVertical: 0, backgroundColor: '#171720' }, loginForm: { marginTop: 39, gap: 10 }, registerForm: { marginTop: 38, gap: 10 }, forgotForm: { marginTop: 38, gap: 10 }, authButton: { height: 55, marginTop: 11, borderRadius: 17, backgroundColor: accent, alignItems: 'center', justifyContent: 'center' }, authPressed: { opacity: .84, transform: [{ scale: .99 }] }, authDisabled: { opacity: .5 }, authButtonText: { color: '#FFFFFF', fontSize: 14, fontWeight: '800' }, error: { color: '#EF7373', fontSize: 11, lineHeight: 16 }, message: { color: '#B8B4C5', fontSize: 12, textAlign: 'center', lineHeight: 18 }, forgot: { height: 43, alignItems: 'center', justifyContent: 'center' }, linkText: { color: '#B8B4C5', fontSize: 13 }, loginBottom: { marginTop: 'auto', alignItems: 'center', gap: 15 }, question: { color: '#77758D', fontSize: 13 }, createButton: { width: '100%', height: 57, borderRadius: 17, borderWidth: 1, borderColor: '#24434A', alignItems: 'center', justifyContent: 'center' }, createText: { color: '#F7F5FA', fontSize: 14, fontWeight: '800' }, close: { width: 38, height: 38, borderRadius: 19, borderWidth: 1, borderColor: '#24434A', backgroundColor: '#13131C', alignItems: 'center', justifyContent: 'center', marginBottom: 38 }, closePressed: { opacity: .72, transform: [{ scale: .96 }] }, loginLink: { alignSelf: 'center', height: 44, marginTop: 18, alignItems: 'center', justifyContent: 'center' }, linkPressed: { opacity: .65 }
});

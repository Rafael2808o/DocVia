...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, title: { color: '#F0FAFB', fontSize: 23, fontWeight: '800', letterSpacing: .1 }, month: { color: '#7E8090', fontSize: 12, marginTop: 7 }, bell: { width: 41, height: 41, borderRadius: 21, borderWidth: 1, borderColor: '#282A35', backgroundColor: '#0B171A', alignItems: 'center', justifyContent: 'center' }, weekControls: { height: 28, marginTop: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, weekButton: { width: 28, height: 28, borderRadius: 10, borderWidth: 1, borderColor: '#2A2B35', backgroundColor: '#0B171A', alignItems: 'center', justifyContent: 'center' }, weekLabel: { color: '#9799A8', fontSize: 10, fontWeight: '700', textTransform: 'capitalize' },
  calendar: { flexGrow: 1, justifyContent: 'center', gap: 7, paddingTop: 11, paddingBottom: 27 }, day: { width: 42, height: 70, borderRadius: 21, borderWidth: 1, borderColor: '#282A35', backgroundColor: '#0B171A', alignItems: 'center', justifyContent: 'center', gap: 6 }, dayActive: { backgroundColor: violet, borderColor: violet }, dayPressed: { opacity: .82, transform: [{ scale: .97 }] }, dayName: { color: '#878998', fontSize: 9, fontWeight: '700' }, dayNameActive: { color: '#D8FBFC' }, dayNumber: { color: '#F0FAFB', fontSize: 14, fontWeight: '800' }, dayNumberActive: { color: '#FFFFFF' },
  sectionLabel: { color: '#858797', fontSize: 9, letterSpacing: 1.3, fontWeight: '800', marginBottom: 14 }, deadlines: { gap: 12 }, deadlineCard: { minHeight: 94, borderRadius: 17, borderWidth: 1, borderColor: '#282A35', backgroundColor: '#0B171A', paddingVertical: 14, paddingLeft: 32, paddingRight: 14, flexDirection: 'row', alignItems: 'center' }, deadlineAccent: { position: 'absolute', left: 16, top: 17, bottom: 17, width: 4, borderRadius: 3 }, deadlineCopy: { flex: 1, minWidth: 0 }, deadlineName: { color: '#F0FAFB', fontSize: 12, fontWeight: '700' }, deadlineDate: { color: '#8B8D9B', fontSize: 10, marginTop: 5 }, deadlineFile: { color: '#888A98', fontSize: 10, marginTop: 6 }, dueBadge: { minWidth: 35, height: 26, borderRadius: 13, alignItems: 'center', justifyContent: 'center', marginLeft: 8 }, dueText: { fontSize: 10, fontWeight: '800' },
  emptyDeadline: { minHeight: 94, borderRadius: 17, borderWidth: 1, borderColor: '#282A35', backgroundColor: '#0B171A', padding: 16, justifyContent: 'center' }, emptyTitle: { color: '#F0FAFB', fontSize: 13, fontWeight: '700' }, emptyText: { color: '#888A98', fontSize: 10, marginTop: 6, lineHeight: 15 },
  alertBox: { minHeight: 75, borderRadius: 17, borderWidth: 1, borderColor: '#29255E', backgroundColor: '#0D0D1C', flexDirection: 'row', alignItems: 'center', gap: 13, paddingHorizontal: 16, marginTop: 17 }, alertText: { color: '#AAA9BA', fontSize: 11, lineHeight: 17, flex: 1 }, alertStrong: { color: '#9C91FF', fontWeight: '800' }
});

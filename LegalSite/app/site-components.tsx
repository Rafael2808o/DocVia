...
export function LegalShell({ children }: { children: React.ReactNode }) {
  return <div className="site"><div className="wrap"><div className="topbar"><Brand /><nav className="topnav" aria-label="Navegação principal"><a href="/privacidade/">Privacidade</a><a href="/termos/">Termos</a><a href="/excluir-conta/">Excluir conta</a></nav></div>{hasPendingLegalIdentity ? <div className="pending" role="alert">Versão de preparação: informe o responsável legal e o e-mail público antes da publicação.</div> : null}{children}</div></div>;
}
...
export function Footer() { return <footer><div className="footer-row"><span>© 2026 DocVia · {siteConfig.controller}</span><div className="footer-links"><a href="/privacidade/">Privacidade</a><a href="/termos/">Termos</a><a href="/excluir-conta/">Excluir conta</a></div></div></footer>; }
